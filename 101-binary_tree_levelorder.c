...
size_t binary_tree_height(const binary_tree_t *tree)
{
	...
	else
	{
		if (tree)
		{
			...
			l = tree->right ? l + binary_tree_height(tree->right) : 0;
		}
		return ((l > r) ? l : r);
	}
}
...
/**
 * binary_tree_depth - depth pf specified node from root
 * @tree: node to check te=he depth
 * Return: 0 is it id the root or number of depth
*/
...
/**
 * binary_tree_levelorder - print the nodes element in a level- order
 * @tree: root node
